...
### Cafe Menu
**Description**:  
Reinforce understanding of CSS layout and styling by building a menu page for a cafe. This project focuses on applying CSS properties like `color`, `font`, and `size` to style elements such as headings, paragraphs, and lists.
